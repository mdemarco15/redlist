...
class RestorationWebPlugin {
  ...
  static void registerWith(Registrar registrar) {
    final MethodChannel channel = MethodChannel('flutter/restoration', const StandardMethodCodec(), registrar);
  ...
  Future<dynamic> handleMethodCall(MethodCall call) async {
    switch (call.method) {
      case 'get':
        ...
        final ByteData? encoded = const StandardMessageCodec().encodeMessage(json != null ? jsonDecode(json) : null);
      ...
      case 'put':
        ...
        final Object? decoded = const StandardMessageCodec().decodeMessage(data.buffer.asByteData(
          data.offsetInBytes,
          data.lengthInBytes,
        ));
